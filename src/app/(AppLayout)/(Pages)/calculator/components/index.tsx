...
function Main() {
    ...
    return (
        <section className="my-10 flex w-full flex-col items-center gap-2">
            <div
                className="flex w-[85vw] max-w-2xl flex-col items-center gap-2">
                ...
                <div className="form-control w-full">
                    <label className="label">
                        <span
                            className="label-text">Выберите расчетную валюту</span>
                    </label>
                    <Select name="currency-select1"
                            components={{Option: IconOption}}
                            onChange={(e) =>
                                setSelectedCurrency({
                                    value: e!.value,
                ...
                <div>
                    *Все цены указаны - приблизительно, конечная цена может
                    отличаться.
                </div>
            </div>
        </section>
